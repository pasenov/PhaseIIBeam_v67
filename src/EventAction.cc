...
void EventAction::EndOfEventAction(const G4Event* evt)
{
 ...
 analysisManager->FillH2(2, fPointExitAl.x(), fPointExitAl.y());
 analysisManager->FillH2(3, fPointExitScint1.x(), fPointExitScint1.y());
 analysisManager->FillH2(4, fPointExitPixel12.x(), fPointExitPixel12.y());
 analysisManager->FillH2(5, fPointExitSensor1.x(), fPointExitSensor1.y());
 analysisManager->FillH2(6, fPointExitSensor2.x(), fPointExitSensor2.y());
 analysisManager->FillH2(7, fPointExitPixel34.x(), fPointExitPixel34.y());
 analysisManager->FillH2(8, fPointExitScint2.x(), fPointExitScint2.y());
